...
/* 메모장
	...
	=========================================================
	어려움(귀찮):
	데미지 받으면 뒤로 굴르는거 추가해줘야함 + 무적 애니메이션 추가 -> 귀찮은데할만함 그래서 어려움[상태 추가 + 애니메이션 추가]
	시작시 별타고 와서 착지함 -> 이게 뭐임?

	=============================================================
	중간:

	변신 하면 멈추고  화면 까맣게하고 자세 잡는 애니메이션 추가 ->페이드아웃 인 사용 시간 멈추는건 김상완한테 
	=================================================================
	쉬움:

	시작애니메이션 캡처 본으로 써도 될 듯 = 백터 저장해서 꺼내주면 될 것 같음 ?일단 다 자름? [반 완] 엔딩부분짤라야함 ㅇㅈ?
	보스 애니메이션 죽는 수정? = 삭제만시켜주면 [완]
	=======================집가서 할 것================================
	


	커비
	별모양 날아가게 = 방향만 넣어주면 완성 = 90;
 
	보스 && 몬스터

	보스데미지 받을때 이펙트추가 = 시간차에따라 생겨줘야할듯? = 90;
